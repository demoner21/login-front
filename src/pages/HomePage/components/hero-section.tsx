            ...
            <div className="relative z-10 h-full flex flex-col">
                        ...
                        <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto text-left">
                            <div className="flex gap-4 items-start justify-center md:justify-start">
                                ...
                                <p className="text-lg md:text-xl text-gray-100 leading-relaxed">
                                    Dive into a world of possibilities where traditional farming meets
                                    modern solutions.
                                </p>
                            </div>
                            <div className="flex items-start justify-center md:justify-start">
                                <p className="text-lg md:text-xl text-gray-100 leading-relaxed">
                                    Explore Sustainable Agricultural Solutions And Cutting-Edge
                                    Technologies.
                                </p>
                            </div>
                        </div>
                ...
                <div className="absolute bottom-8 w-full">
                    <Container className="w-full flex justify-center md:justify-end">
                        <a
                            href="#about-us"
                            className="flex items-center gap-2 text-sm font-medium text-white hover:text-white-300 transition-colors duration-300"
                        >
