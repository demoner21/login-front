...
const ProfilePage = () => {
    ...
    const toggleEdit = (section: keyof EditMode) => {
    ...
    const handleSave = async (section: keyof EditMode) => {
        setIsSaving(true);
        const sectionFields: Record<keyof EditMode, (keyof FormData)[]> = {
        ...
        <div className="p-4 lg:p-8 w-full max-w-5xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:justify-between gap-6">
                            <div className="flex flex-col sm:flex-row items-center gap-6 w-full">
                                <div className="relative shrink-0">
                                    <div
                                        className={`relative rounded-full overflow-hidden w-24 h-24 border-4 border-gray-50 shadow-sm ${
                                            editMode.header ? 'cursor-pointer group' : ''
                                        }`}
            ...
            {activeTab !== 'my-profile' && activeTab !== 'security' && (
                <div className="bg-white rounded-2xl p-12 shadow-sm border border-gray-100 text-center animate-in fade-in duration-500">
                    ...
                    <p className="text-gray-500 max-w-md mx-auto">Esta seção está sendo desenvolvida.</p>
                </div>
            )}
        </div>
    );
