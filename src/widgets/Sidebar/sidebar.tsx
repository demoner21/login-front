...
const NavItem = ({ to, icon: Icon, isExpanded, children }: NavItemProps) => (
    <NavLink
        to={to}
        className={({ isActive }) =>
    ...
    return (
        ...
        >
            ...
            <div className="p-3">
                ...
                <button
                    onClick={logout}
                    className={`mt-2 flex w-full items-center space-x-3 rounded-md p-3 text-sm font-medium text-gray-600 hover:bg-gray-100 ${
                        !isExpanded ? 'justify-center' : ''
                    }`}
                >
